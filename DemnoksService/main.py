...
#     res = g.exchange_rate(date=str(today), currency="新币").to_dict('index')
#     fSellPri = float(res[0]['fSellPri'])
#     return fSellPri
...
def help(update, context):
    help_list = '/sgd2cny   SGD to CNY\n' \
                '/xmr2btc   XMR to BTC\n' \
                '/eth2btc   ETH to BTC'

    update.message.reply_text(help_list)
